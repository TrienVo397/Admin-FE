...
export const HoverExpandSider: React.FC<RefineThemedLayoutV2SiderProps> = ({
    ...
    const siderStyles: React.CSSProperties = {
        ...
        boxShadow: isHovered && siderCollapsed ? "2px 0 8px rgba(0,0,0,0.15)" : "none",
        zIndex: isHovered && siderCollapsed ? 1000 : fixed ? 999 : "auto",
    };
    ...
    return (
        <>
            {fixed && (
                <div
                    style={{
                        width: effectiveCollapsed ? "80px" : "200px",
                        transition: "all 0.3s ease-in-out",
                    }}
                />
            )}
            ...
            >
                ...
                >
                    <RenderToTitle collapsed={effectiveCollapsed} />
                </div>
                {renderMenu()}
            </Layout.Sider>
        </>
